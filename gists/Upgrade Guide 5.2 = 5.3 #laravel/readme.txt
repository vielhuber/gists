...
# in config/app.php einfügen
#  bei providers: Illuminate\Notifications\NotificationServiceProvider::class
#  bei aliases: 'Notification' => Illuminate\Support\Facades\Notification::class